          ...
          <div className="w-full md:w-1/2 bg-gray-200 rounded-t-lg md:rounded-l-lg md:rounded-t-none flex items-center justify-center">
            {pin.image && (
              <img
                src={pin.image.url}
                alt=""
                className="object-cover w-full rounded-t-lg md:rounded-l-lg md:rounded-t-none h-64 md:h-full"
              />
            )}
          </div>
          ...
          <div className="w-full md:w-1/2 p-6 flex flex-col">
            <div className="flex items-center justify-between mb-4 flex-wrap">
              {edit ? (
                <input
                  ...
                  className="common-input mb-2 w-full md:w-1/2"
              ...
              {pin.owner && pin.owner._id === user._id && (
                <>
                  <button onClick={editHandler} className="mr-2">
                    <FaEdit />
                  </button>
                  <button
            ...
            {edit ? (
              <input
                ...
                className="common-input mb-4 w-full md:w-1/2"
            ...
            {edit && (
              <button
                className="bg-red-500 text-white py-1 px-3 mt-2 mb-2 w-full md:w-1/2"
